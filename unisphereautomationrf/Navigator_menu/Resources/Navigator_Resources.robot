...
NAV_Check the UI of the Trash page
    ...
    run keyword and continue on failure     Wait Until Element Is Visible   ${UNISPHERE_TRASHPAGE_ID}    timeout=77
    run keyword and continue on failure     Wait Until Element Is Visible   ${UNISPHERE_TRASH_BREADCRUMB}    timeout=77
    run keyword and continue on failure     Wait Until Element Is Visible   ${UNISPHERE_TRASH_BREADCRUMB}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_TRASH_BREADCRUMB}  timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_TRASHCAN_ICON}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_TRASH_DESCRIPTION}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_TRASHVIDEO_ICON}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_SEARCH_TEXTBOX}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_SORTBY_LABEL}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_ASCENDING_BUTTON}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_DESCENDING_BUTTON}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_SORTBY_LIST}    timeout=77
#    run keyword and continue on failure     Page should contain element  ${UNISPHERE_TRASHTABLETOTAL_TEXT}    timeout=25
    #run keyword and continue on failure     Mouse over  ${UNISECURE_FLOATBTN_ICON}
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_RESTORE_BTN}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_DELETE_BTN}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_TRASHPAGINATIONALL_LINKS}  timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_ITEMSPERPAGE_LABEL}    timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_ITEMSPERPAGE_ID}   timeout=77
    run keyword and continue on failure     Page should contain element  ${UNISPHERE_ITEMSPERPAGE_OPTIONS}  timeout=77
...
NAV_Select Updated By option in Trash page
    ...
    Wait Until Element Is Visible  ${UNISPHERE_SORTBY_LIST}    timeout=77
    Click Element  ${UNISPHERE_SORTBY_LIST}
    Select From List By Index  ${UNISPHERE_SORTBY_LIST}  1
    Wait Until Element Is Visible  ${UNISPHERE_TRASHTABLESELECTALL_CHKBX}    timeout=77
...
NAV_Check user is able to Expand/Collapse each icon in Navigator menu
    ...
    FOR    ${i}  IN  @{expandcollapse}
        Click Element  ${i}
        run keyword and ignore error    Wait Until Element Is Visible    ${UNISPHERE_EXPANDCOLLAPSE_ROTATEDOWN} [${j}]    timeout=20
		${j}=   evaluate  ${j}+1
        sleep  2s
...
NAV_Navigate to each left menu link
    ...
    FOR    ${i}  IN  @{LeftMenuLinks}
        Click Element  ${i}
        run keyword and ignore error     Wait Until Element Is Visible   ${UNISPHERE_TRASHTABLEFIRSTNAME_TEXT}    timeout=20
    END
...
NAV_Click on First link in the Trash page
    ...
    COMMON_Scroll to bottom of the page
    Wait Until Element Is Visible    ${UNISPHERE_TRASHPAGINATIONALL_LINKS}
    ${Pagination_Countlinks} =  Get Element Count   ${UNISPHERE_TRASHPAGINATIONALL_LINKS}
