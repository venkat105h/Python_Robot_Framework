...
${SYSTECH_LINKEDIN_LINK}                    https://www.linkedin.com/showcase/systech-insight
${SYSTECH_FACEBOOK_LINK}                    https://www.facebook.com/systechone
${SYSTECH_TWITTER_LINK}                     https://twitter.com/systechone
${SYSTECHONE_HOME_LINK}                     https://www.systechone.com/
${UNISPHERE_BUILD_VERSIONNO}                1.3.0
${UNISPHERE_BUILD_NUMBER}                   20190927-150755
#${UNISECURE_ADMINISTRATOR_USERNAME}         AdminUser2
...
Chinese Data Translate is displayed
    ...
    run keyword and continue on failure  Data Translate comparision    ${SOL_ABOUT_XPATH}   ${CHINESEABOUT}
    run keyword and continue on failure  Data Translate comparision    ${SOL_UNISPHEREXPATH_TXT}   ${CHINESEUNISPHERETEXT}
    run keyword and continue on failure  Data Translate comparision    ${SOL_UNITRACEXPATH_TXT}   ${CHINESUNITRACETEXT}
    run keyword and continue on failure  Data Translate comparision    ${SOL_UNISECUREXPATH_TXT}   ${CHINESUNISECURETEXT}
    run keyword and continue on failure  Data Translate comparision    ${SOL_UNISERIESXPATH_TXT}   ${CHINESUNISERIESTEXT}
    run keyword and continue on failure  Data Translate comparision    ${SOL_FOLLOWUSXPATH_TXT}   ${CHINESEFOLLOWUSTEXT}
    run keyword and continue on failure  Data Translate comparision    ${SOL_CONTACTUSXPATH_TXT}   ${CHINESECONTACTUSTEXT}
    run keyword and continue on failure  Data Translate comparision    ${SOL_NEEDHELPXPATH_TXT}  ${CHINESENEEDHELPTEXT}
