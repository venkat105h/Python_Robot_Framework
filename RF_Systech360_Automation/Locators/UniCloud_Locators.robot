...
${CLD_ENG_QA_TEXT}                  //*[@id="Engineering QA-1"]
...
${CLD_TABLE_SAVE_BTN}               id=common-save-
...
${CLD_EDIT_CUST_FEAT_BTN}           id=common-edit-
...
${CLD_TOGGLE_SWITCH}                xpath=(//div[contains(@class,'toggle-switch')and contains(@id,'-
${CLD_SERVER_NAME_QA}               //*[@id="100000002-1"]