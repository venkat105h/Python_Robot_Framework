...
${UNISPHERE_ABOUTCLOSE_BTN}               //*[@id="close-btn"]
...
${UNISPHERE_PREFERENCESDESIGNER_ROLE}     goToDesigner
...
${UNISPHERE_VIDEO_SECTION}                (//div[@id='video-section'])[2]
...
${UNISPHERE_PUBAPPROVEDSCENEITEMNAME_ID}     //div[@id='approvedScene']//*[@id="PublishedScene_itemName_0"]
...
${UNISPHERE_EDITORINCLUDEDSUBORDINATE_LBL}   parent_includeChildrenLbl
